...
import me.xiaopan.examples.android.fragment.SmallImageFragment;
import android.os.Bundle;
import android.support.v4.app.Fragment;
import android.support.v4.app.FragmentManager;
import android.support.v4.app.FragmentStatePagerAdapter;

public class SmallImageFragmentPagerAdapter extends FragmentStatePagerAdapter {
	private int[] images;
	
	public SmallImageFragmentPagerAdapter(FragmentManager fragmentManager){
	...
	public Fragment getItem(int position) {
		SmallImageFragment imageFragment = new SmallImageFragment();
